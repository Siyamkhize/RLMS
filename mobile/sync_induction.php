...
$checkQuery = "SELECT clocking_id FROM induction_clocking WHERE LearnerID = ? AND clock_in_time = ? AND (clock_out_time = ? OR clock_out_time IS NULL)";
...
if ($checkStmt->num_rows > 0) {
    ...
    // Insert new record
    $isSynced = 1;
    $query = "INSERT INTO induction_clocking (LearnerID, clock_date, clock_in_time, clock_out_time, contact_time, signature, synced) 
              VALUES (?, ?, ?, ?, ?, ?, ?)";
