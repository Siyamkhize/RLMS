<?php
// arl: ARPL endpoint to retrieve existing data for a learner
...
try {
    ...
    $table_check = $conn->query("SHOW TABLES LIKE 'arpl_appendix_e'");
    ...
    // Get Appendix F
    $table_check = $conn->query("SHOW TABLES LIKE 'arpl_appendix_f'");
    if ($table_check && $table_check->num_rows > 0) {
    ...
    // Get Criteria
    $table_check = $conn->query("SHOW TABLES LIKE 'arpl_evaluation_criteria'");
    if ($table_check && $table_check->num_rows > 0) {
