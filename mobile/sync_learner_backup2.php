...
try {
    ...
    foreach ($input as $item) {
        ...
        $fields = [
            ...
            'profile_image' => $profileImagePath ?? $learner['profile_image'] ?? null,
            'signature' => $signaturePath ?? $learner['signature'] ?? null,
            ...
            'witness_signature' => $witnessSignaturePath ?? $learner['witness_signature'] ?? null,
        ];
