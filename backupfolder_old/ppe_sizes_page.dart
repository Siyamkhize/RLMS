...
class _PPESizesPageState extends State<PPESizesPage> {
  ...
  Future<void> _loadFromServer() async {
    try {
      final url = Uri.parse('${AppConfig.baseUrl}/ppe_sizes.php?learner_id=${widget.learnerID}');
  ...
  Future<bool> _syncToServer(Map<String, dynamic> data) async {
    try {
      ...
      debugPrint('[PPE] Server response (${response.statusCode}): ${response.body}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('PPE Sizes - ${widget.learnerName ?? "Learner ${widget.learnerID}"}'),
