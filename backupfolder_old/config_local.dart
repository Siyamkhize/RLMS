class AppConfig {
  ...
  // ========================================
  static const String serverHost = 'localhost'; // Local server
  static const int serverPort = 8000; // Local PHP server port
  ...
  static String get facilitatorClockoutUrl => '$baseUrl/facilitator_clockout.php';
  ...
  static String get syncLearningPathwayUrl => '$baseUrl/syncLearningpathway.php';
  static String get syncPathwaySelectionUrl => '$baseUrl/syncPathwaySelection.php';
  ...
  static String get syncQualificationPathwayUrl => '$baseUrl/syncQualification_pathway.php';
  static String get syncQualificationUnitStandardUrl => '$baseUrl/syncQualificationunitstandard.php';
  static String get syncUnitStandardUrl => '$baseUrl/syncUnitstandard.php';
  static String get syncUnitStandardSelectionUrl => '$baseUrl/syncUnit_standard_selection.php';
  static String get syncAssessmentUrl => '$baseUrl/syncAssessment.php';
  static String get syncPoeUrl => '$baseUrl/syncPoe.php';
  static String get syncAcknowledgmentDataUrl => '$baseUrl/sync_acknowlegdementData.php';
  static String get syncMaterialFormsUrl => '$baseUrl/syncMaterialForms.php';
  static String get uploadSaveMaterialFormUrl => '$baseUrl/uploadsaveMaterialForm.php';
  static String get saveReceiptFormUrl => '$baseUrl/save_receipt_form.php';
  static String get saveMaterialsReceivedUrl => '$baseUrl/save_materials_received.php';
  ...
  static String get syncInductionClockingUrl => '$baseUrl/syncInductionClocking.php';
  ...
  static String get getLogisticsClassesUrl => '$baseUrl/get_logistics_classes.php';
  static String get getLogisticsLearnersUrl => '$baseUrl/get_logistics_learners.php';
  static String get getMaterialInventoryUrl => '$baseUrl/get_material_inventory.php';
  static String get getMaterialIssuancesUrl => '$baseUrl/get_material_issuances.php';
  static String get saveMaterialIssuanceUrl => '$baseUrl/save_material_issuance.php';
