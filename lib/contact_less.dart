    ...
    try {
      ...
      if (result != null && result is String) {
        ...
        try {
          ...
          final decodedImage = img.decodeImage(bytes)!; // Image is preprocessed
          if (decodedImage == null) {
            debugPrint('[CONTACTLESS] Failed to decode captured image');
            setState(() {
              _isCapturing = false;
              _statusMessage = 'Failed to decode captured image';
              _isClockingIn[_currentLearnerIdForClocking!] = false;
              _currentLearnerIdForClocking = null;
              _currentClockingAction = null;
            });
