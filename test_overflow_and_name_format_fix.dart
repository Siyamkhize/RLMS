void main() {
  ...
  final testLearner = {
    ...
    'displayName':
        'Doe John (9301156789012)', // Backend format: "Surname Name (ID)"
  ...
  final displayName =
      testLearner['displayName']?.toString() ?? '$surname $name ($idNumber)';
  ...
  print(
      '   ✓ Changed Flexible(flex: 0) to Container with maxHeight constraint');
